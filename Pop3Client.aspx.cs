...
public partial class Pop3Client : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            strCustEmail = Session["cemail"].ToString();
            Session["email"] = "cloud@appmor.com";
            Session["pwd"] = "F@ztrack2015";
            Email = "cloud@appmor.com"; //Session["email"].ToString();
            Password = "F@ztrack2015"; //Session["pwd"].ToString();
        }
        catch 
        {
        ...
        for (int i = 0; i < emails.Count; i++)
        {
            ...
            //if (email.From.Contains("@faztrack.com"))
            //{
