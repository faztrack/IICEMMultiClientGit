                            ...
                            <tr>
                                <td valign="top" width="100%">&nbsp;&nbsp;
                                    <table valign="top">
                                        <tr>
                                            <td align="left">
                                                &nbsp;&nbsp;<strong>Crew/Employee Name:</strong>
                                            </td>
                                            <td align="left">
                                           ...
                                           <td align="left">
                                            ...
                                            <td align="right">
                                                <asp:LinkButton ID="btnSearch" runat="server" CssClass="button" Style="padding-left: 11px" Text="Search" OnClick="btnSearch_Click"></asp:LinkButton>&nbsp;
                                    <asp:LinkButton ID="lnkViewAll" runat="server" CssClass="underlineButton" Text="Reset" OnClick="lnkViewAll_Click"></asp:LinkButton>
                                           ...
                                           <td align="right">
                                            ...
                                            <td align="right">
                                                &nbsp;&nbsp;
                                                 <asp:LinkButton ID="btnView" runat="server" CssClass="button" Text="View" Style="padding-left: 10px" OnClick="btnView_Click"></asp:LinkButton>
                                            </td>
                                            <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;<b>Division:</b>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" width="223px">
                                         ...
                                         <td align="left" width="380px">    
                                              ...
                                              <asp:CheckBox ID="chkTotalhours" runat="server" style="float:right;margin-left:30px" Font-Bold="true" Text="Summary Hours" AutoPostBack="true" OnCheckedChanged="chkTotalhours_CheckedChanged" />
                                             
                                            <asp:RadioButtonList ID="radEmployeeType" style="float:right" runat="server" OnSelectedIndexChanged="radEmployeeType_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                            ...
                                            <asp:GridView ID="grdLaberTrack" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="DATE/EDIT">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="InkLaborDate" runat="server" Style="text-decoration: underline"></asp:HyperLink>
                                                            <br></br>
