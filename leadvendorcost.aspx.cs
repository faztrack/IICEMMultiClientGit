...
public partial class leadvendorcost : System.Web.UI.Page
{
    ...
    {
        KPIUtility.SaveEvent(this.Page.AppRelativeVirtualPath, btnGoToPayment.ID, btnGoToPayment.GetType().Name, "Click"); 
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        drNew = tmpTable.NewRow();
        drNew["Date"] = "Project:";
        drNew["Vendor"] = ddlEstimate.SelectedItem.Text;
        drNew["Trade"] = "";
        drNew["Description"] = "";
        drNew["Category"] = "";
        drNew["Amount"] = "";
