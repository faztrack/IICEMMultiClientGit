<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="change_order_sections.aspx.cs" Inherits="change_order_sections" Title="Change Order Sections" %>
        ...
        <tr>
            <td align="center" class="cssHeader">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left"><span class="titleNu">Change Order Sections</span></td>
                        <td align="right"></td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <table cellpadding="4" cellspacing="8" width="100%" align="center">
                                        <tr>
                                            <td align="center" valign="top">
                                                <h2>Select Change Order Sections</h2>
                                            </td>
