...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <table cellpadding="0" cellspacing="10" width="100%">
            ...
            <tr>
                <td style="padding: 4px 0;" align="right" valign="top"><b>Subject:</b></td>
                <td colspan="3">
                    <asp:Label ID="lblSubject" runat="server" Width="445px" CssClass="mailSubject"></asp:Label></td>
            </tr>
            <tr>
                <td style="padding: 4px 0;" align="right" valign="top"><b>Date:</b></td>
                <td colspan="3" class="mailIDAll">
                    <asp:Label ID="lblDate" runat="server"></asp:Label>
                    	<%--Tue, Nov 29, 2017 at 8:26 PM--%>
                    </td>
            </tr>
            <tr>
                <td width="124px" align="right"><b>Attachments:</b></td>
                <td colspan="3" class="mailIDAll">
...
<%--            <tr>
                <td align="left" colspan="4"><b class="msgBody">Message Body:</b></td>
            </tr>--%>
            <tr>
