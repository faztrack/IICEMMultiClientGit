(function (factory) {
    ...
    var $activityObject = $('<div/>')
        ...
        $gellarytitleObject = $('<div/>', {
            class: 'imagelightbox-gellarytitle',
            html: '&nbsp;'
        }),
        $overlayObject = $('<div/>', {
    ...
    $.fn.imageLightbox = function (opts) {
        var options = $.extend({
            ...
            _onStart = function () {
                ...
                if (options.gellarytitle) {
                    $wrapper.append($gellarytitleObject);
                }
            },
            ...
            gellarytitleReset = function () {
                $gellarytitleObject.html('&nbsp;');              
                $gellarytitleObject.html($(target).data('ilb3-gellarytitle'));
