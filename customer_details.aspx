<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="customer_details.aspx.cs" Inherits="customer_details" Title="Customer Information" %>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="left"><span class="titleNu">
                                    <asp:Label ID="lblHeaderTitle" runat="server" CssClass="cssTitleHeader">Add New Customer</asp:Label></span></td>
                ...
                <tr>
                    <td align="center">
                        <table cellpadding="4px" cellspacing="4px" width="900px" align="center">
                            <tr>
                                ...
                                <td align="left" width="20%">
                                    <asp:TextBox ID="txtFirstName1" runat="server" Width="200px" TabIndex="1"></asp:TextBox>
                                </td>
                                <td align="right" width="30%">
                                    <b>First Name 2: </b></td>
                                <td align="left" width="20%">
                                    <asp:TextBox ID="txtFirstName2" runat="server" TabIndex="16" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                ...
                                <td align="right"><b>Status:</b><b> </b></td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlStatus" runat="server" TabIndex="20" Width="212px">
                            ...
                            <tr>
                                <td align="right">
                                    <span class="required">* </span><b>Zip Code:</b></td>
                                <td align="left">
                                    <asp:TextBox ID="txtZipCode" runat="server" TabIndex="6" Width="200px"></asp:TextBox>
                                </td>
                                <td align="right" valign="top">
                                    <b>Status Note: </b>
                                </td>
                                <td align="left" rowspan="2">
                                    <asp:TextBox ID="txtStatusNote" runat="server" MaxLength="50"
                                        onkeydown="checkTextAreaMaxLengthWithDisplay(this,event,'50',document.getElementById('head_txtDisplay'));"
                                        TabIndex="21" TextMode="MultiLine" Width="204px" Height="45px"></asp:TextBox>
                            ...
                            <tr>
                                <td align="right"></td>
                                <td align="left">
                                    <asp:CheckBox ID="chkOptIn" runat="server" Text="Opt-in for SMS Notification" />
                                </td>
                                <td align="right"></td>
                            </tr>
                            <tr>
                                ...
                                <td align="right">
                                    <span class="required">* </span><b>Lead Source:</b>
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="right">
                                    <b>Customer Login Active:</b>
                                </td>
                                <td align="left">
                                    <asp:RadioButtonList ID="rdoCustomerLogin" runat="server"
                                        RepeatDirection="Horizontal" AutoPostBack="True"
                                        OnSelectedIndexChanged="rdoCustomerLogin_SelectedIndexChanged"
                                        TabIndex="10">
                                ...
                                <td align="right">
                                    <asp:Label ID="lblRegDate" runat="server" Text="Entry Date:" ForeColor="#717171" Visible="False"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:Panel ID="pnlCustomerPass" runat="server" Visible="false"
                                        BackColor="#e5e5e5">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblChangePassword" runat="server"
                                                        Text="Please input password and re-type password to reset password."
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password"
                                                        AutoComplete="false" TabIndex="12"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="txtNotes" runat="server" TabIndex="23" TextMode="MultiLine"
                                        onkeydown="checkTextAreaMaxLengthWithDisplay(this,event,'500',document.getElementById('head_txtDisplay2'));"
                        ...
                        <table width="100%" align="center">
                            ...
                            <%-- <tr>
                                <td align="center" colspan="4">
                                    <asp:LinkButton ID="lnkNewMessage" runat="server" Visible="False">Compose New Message</asp:LinkButton>
                                </td>
                            </tr>--%>
                        </table>
                        ...
                        <table width="100%">
                            <tr>
                                <td align="center" class="cssHeader">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="left"><span class="titleNu"><span id="spnPnlEstimate" class="cssTitleHeader">
                                                <asp:ImageButton ID="ImageEstimateMain" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0 0 4px; vertical-align: middle;" TabIndex="40" />
                                                <font style="font-size: 16px; cursor: pointer;">Sold Estimates, Contracts and Change Orders</font></span></span>
                                                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender7" runat="server" CollapseControlID="spnPnlEstimate" Collapsed="True" CollapsedImage="Images/expand.png" ExpandControlID="spnPnlEstimate" ExpandedImage="Images/collapse.png" ImageControlID="ImageEstimateMain" SuppressPostBack="true" TargetControlID="pnlEstimate">
                            ...
                            <tr>
                                <td>
                                    <asp:Panel ID="pnlEstimate" runat="server">
                                        <table align="center" cellpadding="0" cellspacing="2" class="wrapper" width="100%">
                                            <tr>
                                                <td align="center">
                                                    <asp:GridView ID="grdCustomerEstimate" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="estimate_id" OnRowDataBound="grdCustomerEstimate_RowDataBound" Width="100%">
                                                        <Columns>
                                                            <asp:BoundField DataField="estimate_name" HeaderText="Project Name" />
                                                            <asp:BoundField DataField="sale_date" DataFormatString="{0:d}" HeaderText="Sale Date" />
                                                            <asp:BoundField HeaderText="Sale Amount">
                                                            ...
                                                            <asp:TemplateField HeaderText="Contract Documents">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkContractDoc" runat="server" OnClick="GetPDF">PDF</asp:LinkButton>
                                                                    ,
                                                            <asp:LinkButton ID="lnkHTML" runat="server" OnClick="GetHTML">Quick Contract</asp:LinkButton>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Change Orders">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkViewCO" runat="server"></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="left"><span class="titleNu"><span id="spnPnlCompMessage" class="cssTitleHeader">
                                                <asp:ImageButton ID="ImageCompMessageMain" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0 0 4px; vertical-align: middle;" TabIndex="40" />
                                            ...
                                            <td align="left">
                                                <span class="titleNu">
                                                    <span id="spnPnlDocAttach" class="cssTitleHeader">
                                                        <asp:ImageButton ID="ImageDocAttachMain" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0 0 4px; vertical-align: middle;" TabIndex="40" />
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:Button ID="btnSaveFiles" runat="server" OnClick="btnSaveFiles_Click"
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:GridView ID="grdCustomersFile" runat="server" AutoGenerateColumns="False"
                                                                CssClass="mGrid"
                                                                OnRowDataBound="grdCustomersFile_RowDataBound" Width="75%"
                                            ...
                                            <td align="left">
                                                <span class="titleNu">
                                                    <span id="spnPnlCallLog" class="cssTitleHeader">
                                                        <asp:ImageButton ID="ImageCallLogMain" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0 0 4px; vertical-align: middle;" TabIndex="40" />
                                            ...
                                            <td align="left">
                                                <span class="titleNu">
                                                    <span id="spnPnlContact" class="cssTitleHeader">
                                                        <asp:ImageButton ID="ImageContactMain" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0 0 4px; vertical-align: middle;" TabIndex="40" />
                                ...
                                <td>
                                    <asp:Panel ID="pnlTGIContactMain" runat="server" Height="100%">
                                        <table class="wrapper" cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <asp:Panel ID="Panel1" runat="server">
                                                                    <span id="PnlCtrlID1" runat="server">
                                                                        <asp:LinkButton ID="lnkAddNewContact" runat="server" CssClass="button" Width="160px">
                                                                            <asp:ImageButton ID="ImageTGI1" runat="server" ImageUrl="~/Images/expand.png" CssClass="blindInput" Style="margin: 0px; background: none; border: none; box-shadow: none; padding: 0px; vertical-align: middle;" TabIndex="40" />
                                                                            Add New Contact
                                                                        </asp:LinkButton>
                                                                    </span>
                                                                </asp:Panel>
                                                                            ...
                                                                            <td valign="top">
                                                                                <table style="padding: 0px; margin: 0px;" width="100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactFirstName" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactLastName" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactTitle" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>&nbsp;</td>
                                                                                        <td align="left">
                                                                                            <asp:Button ID="btnSaveContact" runat="server" CssClass="button" TabIndex="178" Text="Save Contact" OnClick="btnSaveContact_Click" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                            <td valign="top">
                                                                                <table style="padding: 0px; margin: 0px;" width="100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactEmail" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactPhone" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="txtContactMobile" runat="server" Width="341px" TabIndex="177"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>&nbsp;</td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <asp:GridView ID="grdContact" runat="server" AutoGenerateColumns="False" CssClass="mGrid" PageSize="50" Width="100%" OnRowEditing="grdContact_RowEditing"
