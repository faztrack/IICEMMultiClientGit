...
public partial class sales_statistics_excel : System.Web.UI.Page
{
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        string strQ = " SELECT customers.customer_id,customer_estimate.estimate_id,customer_estimate.job_number, " +
                     ...
                     " WHERE customer_estimate.IsEstimateActive = 1 AND customer_estimate.status_id=3 " + strCondition;//customers.status_id NOT IN(4,5) AND 
        ...
        else
        {
            foreach (DataRow dr in dtReport.Rows)
            {
                ...
                decimal ProjectedMarginper = ((TotalProjectRevenue - ProjectBaseCost) / TotalProjectRevenue) * 100;
                decimal ActualMarginper = ((TotalProjectRevenue - TotalProjectCost) / TotalProjectRevenue) * 100;
