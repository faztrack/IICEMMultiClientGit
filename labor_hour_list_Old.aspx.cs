...
public partial class labor_hour_list_Old : System.Web.UI.Page
{
        ...
        try
        {
            if (chkTotalhours.Checked)
            {
                for (int i = subTotalRowIndex; i < grdLaberTrack.Rows.Count; i++)
                {
                    ...
                    DateTime StartTime = Convert.ToDateTime(grdLaberTrack.Rows[i].Cells[11].Text);
                    string eTime = (grdLaberTrack.Rows[i].Cells[12].Text).ToString();
                    if (eTime != null && eTime != "")
                    {
                        DateTime EndTime = Convert.ToDateTime(grdLaberTrack.Rows[i].Cells[12].Text);
    ...
    private void AddTotalRow(string labelText, string value)
    {
        ...
        row.Cells.AddRange(new TableCell[11] { new TableCell (), new TableCell (),new TableCell (), new TableCell (),new TableCell (),new TableCell (),new TableCell (),new TableCell (),//Empty Cell
