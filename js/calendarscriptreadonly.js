...
$(document).ready(function () {
    ...
    $("#head_btnSearch").click(function () {
        ...
        if ($("#head_txtSearch").val() === '' && $("#head_txtSection").val() === '' && $("#head_txtUser").val() === '')
            return;
    ...
    $("#head_lnkViewAll").click(function () {
        ...
        //var UserName = '';
        //PageMethods.GetEvent(nCustId, SectionName, UserName, getSuccess);
        window.location = "schedulecalendarreadonly.aspx?TypeID=1";
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events: "JsonResponsereadonly.ashx",
...
function loadParentEventLinkTable(objEvent) {
    ...
    $.ajax({
        type: "POST",
        url: "schedulecalendarreadonly.aspx/GetParentEventTable",
            ...
            if (response.d.length > 0) {
                ...
                $.each(response.d, function (i, item) {
                    ...
                    trHTML += "<tr>" +
                                ...
                                "<td style='width: 50%; text-align: left;'><label id='lbltitle" + item.link_id + "' class='csslbltitle'>" + item.title + "</label></td>" +
                                ...
                                "<label id='grdlbldependencyType" + item.link_id + "'>" + item.dependency + "</label>" +
                                "<label id='grdlblOffsetdays" + item.link_id + "'>" + item.lag + "</label>" +
                                "</td>" +
                                "</tr>";
                });
