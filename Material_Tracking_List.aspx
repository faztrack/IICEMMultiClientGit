                                ...
                                <td align="center" colspan="7" style="width: 100%;">
                                    <table width="50%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td align="right">
                                        <asp:Label ID="Label8" runat="server" Font-Bold="true" Text="Vendor:"></asp:Label>
                                    </td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlVendor" runat="server" DataTextField="Vendor_name" DataValueField="Vendor_id" AutoPostBack="true" OnSelectedIndexChanged="ddlVendor_SelectedIndexChanged"></asp:DropDownList>
                                            </td>
                                            <td align="left">
