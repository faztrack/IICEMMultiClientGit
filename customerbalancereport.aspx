<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="customerbalancereport.aspx.cs" Inherits="customerbalancereport" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center" class="cssHeader">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="center"><span class="titleNu">Customer Balance Report</span></td>
                                <td align="right"></td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td align="center" colspan="2" style="height: 11px">
                                    <asp:Button ID="btnViewReport" runat="server" Text="View Report"
                                        CssClass="button"  OnClick="btnViewReport_Click" />
