<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="locationdetails.aspx.cs" Inherits="locationdetails" Title="Location Information" %>
                    ...
                    <td align="center" class="cssHeader">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="left">
                                    <span class="titleNu">
                                    <asp:Label ID="lblHeaderTitle" runat="server" CssClass="cssTitleHeader">Add New Location</asp:Label></span></td>
                                <td align="right"></td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td align="center">
                        <table cellpadding="4px" cellspacing="4px" width="500px">
                            ...
                            <tr>
                                ...
                                <td align="right"><span class="required">* </span>Location Name: </td>
                                <td align="left">
