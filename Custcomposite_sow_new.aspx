<%@ Page Language="C#" MasterPageFile="~/CustomerMain.master" AutoEventWireup="true" CodeFile="Custcomposite_sow_new.aspx.cs"
    Inherits="Custcomposite_sow_new" Title="Composite SOW" %>
        ...
        <tr>
            <td align="center" class="cssHeader">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left"><span class="titleNu">Composite SOW
                        </span></td>
                        <td align="right"></td>
                    </tr>
                </table>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <table class="wrapper" width="100%">
                                            <tr>
                                                ...
                                                <td align="left" valign="top">
                                                    <table style="width: 420px;">
                                                        <tr>
                                                            <td style="width: 112px;" align="left" valign="top"><b>Estimate Status:</b> </td>
                                                            <td align="left" valign="top">
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"><b>Tax %:</b> </td>
                                                            <td>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:GridView ID="grdSelectedItem1" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Unit Price" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblItem_price" runat="server" Text='<%# String.Format("{0:C}", Eval("item_cost")) %>' />
                                                                        <asp:Label ID="lblT_Itemprice1" runat="server" Visible="false" Text='<%# String.Format("{0:C}", Eval("item_cost")) %>' />
                                                                    </ItemTemplate>
                                                                    <HeaderStyle Width="5%" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    &nbsp;<asp:GridView ID="grdSelectedItem2" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Unit Price" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblItem_price2" runat="server" Text='<%# String.Format("{0:C}", Eval("item_cost")) %>' />
                                                                                    <asp:Label ID="lblT_Itemprice2" runat="server" Visible="false" Text='<%# String.Format("{0:C}", Eval("item_cost")) %>' />
                                                                                </ItemTemplate>
                                                                                <HeaderStyle Width="5%" />
                                                                            </asp:TemplateField>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Button ID="btnGotoCustomerList" runat="server" CssClass="button" OnClick="btnGotoCustomerList_Click" Text="Back to Dashboard" />
